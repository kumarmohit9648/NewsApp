...
class CameraActivity : AppCompatActivity(), View.OnClickListener, OptionView.Callback {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val cameraType = intent.getStringExtra(AppConstant.CAMERA_TYPE)

        if (cameraType == AppConstant.PHOTO) {
            titleName.text = AppConstant.PHOTO
            camera.mode = Mode.PICTURE
            findViewById<View>(R.id.capturePicture).visibility = View.VISIBLE
            findViewById<View>(R.id.captureVideo).visibility = View.GONE
        } else {
            titleName.text = AppConstant.VIDEO
            camera.mode = Mode.VIDEO
            findViewById<View>(R.id.capturePicture).visibility = View.GONE
            findViewById<View>(R.id.captureVideo).visibility = View.VISIBLE
        }
