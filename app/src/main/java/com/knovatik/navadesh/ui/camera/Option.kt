package com.knovatik.navadesh.ui.camera
...
abstract class Option<T : Any>(val name: String) {
    ...
    class Width : Option<Int>("Width") {
        ...
        override fun getAll(view: CameraView, options: CameraOptions): Collection<Int> {
            ...
            for (i in step until boundary step step) {
                list.add(i)
            }
            return list
        }
    ...
    abstract class Control<T : com.otaliastudios.cameraview.controls.Control>(
    ...
    class Mode : Control<com.otaliastudios.cameraview.controls.Mode>(
        com.otaliastudios.cameraview.controls.Mode::class,
        "Mode"
    )

    class Engine : Control<com.otaliastudios.cameraview.controls.Engine>(
        com.otaliastudios.cameraview.controls.Engine::class,
        "Engine"
    ) {
    ...
    class Preview : Control<com.otaliastudios.cameraview.controls.Preview>(
        com.otaliastudios.cameraview.controls.Preview::class,
        "Preview Surface"
    ) {
        ...
        private fun applyPreview(
            view: CameraView,
            value: com.otaliastudios.cameraview.controls.Preview
        ) {
    ...
    class Flash : Control<com.otaliastudios.cameraview.controls.Flash>(
        com.otaliastudios.cameraview.controls.Flash::class,
        "Flash"
    )

    class WhiteBalance : Control<com.otaliastudios.cameraview.controls.WhiteBalance>(
        com.otaliastudios.cameraview.controls.WhiteBalance::class,
        "White Balance"
    )

    class Hdr : Control<com.otaliastudios.cameraview.controls.Hdr>(
        com.otaliastudios.cameraview.controls.Hdr::class,
        "HDR"
    )
    ...
    class PictureSnapshotMetering : Option<Boolean>("Picture Snapshot Metering") {
        ...
        override fun getAll(view: CameraView, options: CameraOptions) = listOf(true, false)
        override fun set(view: CameraView, value: Boolean) {
            view.pictureSnapshotMetering = value
        }
    }

    class VideoCodec : Control<com.otaliastudios.cameraview.controls.VideoCodec>(
        com.otaliastudios.cameraview.controls.VideoCodec::class,
        "Video Codec"
    )

    class AudioCodec : Control<com.otaliastudios.cameraview.controls.AudioCodec>(
        com.otaliastudios.cameraview.controls.AudioCodec::class,
        "Audio Codec"
    )

    class Audio : Control<com.otaliastudios.cameraview.controls.Audio>(
        com.otaliastudios.cameraview.controls.Audio::class,
        "Audio"
    )

    abstract class Gesture(
        val gesture: com.otaliastudios.cameraview.gesture.Gesture,
        name: String
    ) : Option<GestureAction>(name) {
    ...
    class HorizontalScroll :
        Gesture(com.otaliastudios.cameraview.gesture.Gesture.SCROLL_HORIZONTAL, "Horizontal Scroll")

    class VerticalScroll :
        Gesture(com.otaliastudios.cameraview.gesture.Gesture.SCROLL_VERTICAL, "Vertical Scroll")
    ...
    abstract class Overlay(
        ...
        private val target: com.otaliastudios.cameraview.overlay.Overlay.Target,
        name: String
    ) : Option<Boolean>(name) {
        override fun getAll(view: CameraView, options: CameraOptions) = listOf(true, false)
    ...
    class OverlayInPreview(overlay: View) : Overlay(
        overlay,
        com.otaliastudios.cameraview.overlay.Overlay.Target.PREVIEW,
        "Overlay in Preview"
    )

    class OverlayInPictureSnapshot(overlay: View) : Overlay(
        overlay,
        com.otaliastudios.cameraview.overlay.Overlay.Target.PICTURE_SNAPSHOT,
        "Overlay in Picture Snapshot"
    )

    class OverlayInVideoSnapshot(overlay: View) : Overlay(
        overlay,
        com.otaliastudios.cameraview.overlay.Overlay.Target.VIDEO_SNAPSHOT,
        "Overlay in Video Snapshot"
    )

    class Grid : Control<com.otaliastudios.cameraview.controls.Grid>(
        com.otaliastudios.cameraview.controls.Grid::class,
        "Grid Lines"
    )
    ...
    class PictureFormat : Control<com.otaliastudios.cameraview.controls.PictureFormat>(
        com.otaliastudios.cameraview.controls.PictureFormat::class,
        "Picture Format"
    )
