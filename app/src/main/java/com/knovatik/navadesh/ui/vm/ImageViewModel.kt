...
class ImageViewModel(application: Application) : AndroidViewModel(application) {
    ...
    val images: LiveData<List<Media>> get() = _images

    private var contentObserver: ContentObserver? = null

    private var pendingDeleteImage: Media? = null
    ...
    private suspend fun queryImages(): List<Media> {
        ...
        withContext(Dispatchers.IO) {
            ...
            getApplication<Application>().contentResolver.query(
                ...
                while (cursor.moveToNext()) {
                    ...
                    val image = Media(id, displayName, dateModified, contentUri)
                    images += image
    ...
    private suspend fun performDeleteImage(image: Media) {
        withContext(Dispatchers.IO) {
            try {
                /**
